...
from _03_iteration_output import SubTopicUpdate, ResearchIteration
...
# ORCHESTRATOR LOOP
async def run_orchestrator_loop(goal: str, max_iterations: int = 15) -> ResearchState: 
    ...
    async with search_server:
        ...
        for iteration in range(max_iterations):
            ...
            if decision.is_complete or decision.next_action == "finalize":
